...
par(mfrow = c(2, 2))
plot(dataSub$t,dataSub$Global_active_power, type="l", xlab = "",ylab = "Global Active Power")

plot(dataSub$t,dataSub$Voltage, type="l", xlab = "datetime",ylab = "Voltage")

plot(dataSub$t,dataSub$Sub_metering_1, type="l", xlab = "",ylab = "Energy sub metering")
points(dataSub$t,dataSub$Sub_metering_2, type="l", col="red")
points(dataSub$t,dataSub$Sub_metering_3, type="l", col="blue")
legend("topright", bty="n", lwd=2, cex = 0.8, legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col = c("black","red","blue"))

plot(dataSub$t,dataSub$Global_reactive_power, type="l", xlab = "datetime",ylab = "Global_reactive_power")
dev.off()